  ...
  return (
    <div style={{ color: '#1a202c', fontFamily: 'Arial, sans-serif' }}>
      <section style={{ backgroundColor: '#1e3a8a', color: 'white', padding: '80px 20px', textAlign: 'center' }}>
        <h1 style={{ fontSize: '42px', fontWeight: '900' }}>PROFESSIONAL ROOFING SOLUTIONS</h1>
        <p style={{ fontSize: '20px' }}>WAUKEGAN Roofing Services: Serving IL, WI, & IN Since 2016</p>
      </section>
      <section style={{ padding: '80px 20px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '50px', alignItems: 'center' }}>
          <div>
            <h2 style={{ color: '#1e3a8a', fontSize: '32px' }}>Roof Installation & Replacement</h2>
            <p style={{ fontSize: '18px', margin: '20px 0', lineHeight: '1.6' }}>
              We specialize in residential and industrial roof replacements using premium materials. 
              Our team ensures every roof meets local building codes in Lake County.
            </p>
            <ul style={{ lineHeight: '2', fontSize: '17px' }}>
              <li>✅ Asphalt Shingle Installations</li>
              <li>✅ Flat Roof & Commercial Systems</li>
              <li>✅ Emergency Leak & Storm Repairs</li>
            </ul>
          </div>
