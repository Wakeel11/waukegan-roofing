...
import { Phone, CheckCircle2, Award, ShieldCheck, MapPin } from 'lucide-react';

const serviceData: any = {
  installation: { title: "New Roof Installation", desc: "Expert new roof installations for residential homes using premium architectural shingles. Built to last and withstand local weather." },
      ...
      <section className="bg-[#1e3a8a] text-white py-16 md:py-24 px-4 text-center">
        <div className="container mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-10 opacity-95 max-w-3xl mx-auto">
             WAUKEGAN Roofing Services: Serving the Community Since 2016.
          </p>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-gray-50 p-10 rounded-3xl mb-12 border border-gray-100 shadow-sm">
              ...
              <ul className="space-y-4 font-bold text-slate-700">
                ...
                <li className="flex items-center gap-3"><CheckCircle2 className="text-[#1e3a8a]" /> Established Professionals Since 2016</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="text-[#1e3a8a]" /> Local Beach Park, IL Headquarters</li>
              </ul>
            </div>
          </div>
