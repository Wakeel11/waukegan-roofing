...
// Sab icons yahan define hain taake crash na ho
import { Phone, MapPin, ShieldCheck, Star, CheckCircle2, Award, HardHat, Clock } from 'lucide-react';
    ...
    <div className="pt-20 min-h-screen bg-white font-sans text-slate-900">
      ...
      <section className="bg-[#1e3a8a] text-white py-20 px-4 relative overflow-hidden">
        <div className="container mx-auto text-center relative z-10">
          <div className="flex justify-center items-center gap-2 mb-4">
            ...
            <span className="ml-2 font-bold uppercase tracking-widest text-sm text-gray-200">Top Rated in {city.name}</span>
          </div>
          ...
          <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed font-medium">
            Expert Roof Replacement & Repairs. Serving the {city.name} community with over 10 years of local expertise.
          </p>
          
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a href="tel:8777193793" className="flex items-center justify-center gap-3 bg-[#f97316] hover:bg-orange-600 text-white text-2xl font-black px-8 py-4 rounded-xl shadow-xl transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              Since 2016, <strong>WAUKEGAN Roofing Services</strong> has been a trusted name for quality roofing in <strong>{city.name}, IL ({city.zip})</strong>. 
              Founded by Eduardo Zuniga, our business is built on local accountability and premium craftsmanship. 
              We are a dedicated local team serving the entire Illinois, Wisconsin, and Indiana region.
            </p>

            {/* Bulleted EEAT Section */}
            <div className="bg-gray-50 p-8 rounded-3xl mb-12 border border-gray-100 shadow-sm">
              <h3 className="text-2xl font-bold mb-6 flex items-center gap-2 text-[#1e3a8a]">
                <Award className="text-[#f97316]" /> Why Homeowners in {city.name} Choose Us
              </h3>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  "Fast Emergency Tarping",
                  "Local Illinois Building Code Experts",
                  "Premium Quality Material Warranties"
                ].map((item, idx) => (
                  <li key={idx} className="flex items-center gap-3 text-gray-700 font-semibold text-sm md:text-base">
                    <CheckCircle2 className="text-[#1e3a8a]" size={20} /> {item}
                  </li>
                ))}
              </ul>
            </div>
            ...
            <h3 className="text-3xl font-bold mb-6 text-[#1e3a8a]">Our Core Services</h3>
            <div className="space-y-4 mb-12">
              <div className="p-6 border border-gray-200 rounded-2xl hover:bg-blue-50 transition-colors">
                <h4 className="text-xl font-bold flex items-center gap-3 mb-2 text-[#1e3a8a]">
                  <HardHat className="text-[#1e3a8a]" /> Residential Roof Replacement
                </h4>
                <p className="text-gray-600">From classic architectural shingles to modern flat roofing systems, we provide long-lasting protection for your family.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-2xl hover:bg-blue-50 transition-colors">
                <h4 className="text-xl font-bold flex items-center gap-3 mb-2 text-[#1e3a8a]">
                  <ShieldCheck className="text-[#1e3a8a]" /> Seamless Gutter Installation
                </h4>
                <p className="text-gray-600">Protect your foundation with custom aluminum gutters and downspouts tailored for {city.name} homes.</p>
              </div>
            </div>
            ...
            <div className="bg-[#1e3a8a] text-white p-10 rounded-3xl shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                <h3 className="text-3xl font-bold mb-4">Local Beach Park HQ</h3>
                <p className="text-lg opacity-90 mb-6">
                  Serving IL, WI, and IN with pride. Our central headquarters ensures we reach you quickly for inspections and estimates.
                </p>
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  <div className="flex items-center gap-4">
                    <div className="bg-white/10 p-4 rounded-xl">
                      <MapPin className="text-[#f97316]" size={32} />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-xl">Rapid Local Response</p>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-[#f97316] p-8 rounded-3xl text-white text-center shadow-xl">
      ...
      <section className="bg-gray-50 py-16 border-t border-gray-200">
        <div className="container mx-auto px-4 text-center">
          <h4 className="text-gray-400 font-bold uppercase tracking-widest text-xs mb-10">
            Serving Neighbors Near {city.name}
          </h4>
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
            {localCities.filter(c => c.slug !== cleanSlug).slice(0, 15).map(c => (
              <Link key={c.slug} to={`/roofing-${c.slug}`} className="text-[#1e3a8a] font-black hover:text-[#f97316] transition-colors text-sm uppercase">
                Roofing {c.name}
              </Link>
            ))}
          </div>
