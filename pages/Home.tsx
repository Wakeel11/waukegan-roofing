...
const Home = () => {
  useEffect(() => {
    // LeadSmart Form Injection Logic
    ...
    const container = document.getElementById('form-anchor');
  ...
  return (
    <div style={{ fontFamily: 'Segoe UI, Arial, sans-serif', color: '#1a202c', lineHeight: '1.6' }}>
      ...
      {/* Form Section */}
      <section id="form-anchor" style={{ padding: '60px 20px', backgroundColor: '#ffffff', minHeight: '500px' }}>
      ...
      <section style={{ backgroundColor: '#f8fafc', padding: '60px 20px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <p style={{ fontSize: '18px', color: '#4a5568' }}>Operating with family values across the Tri-State area since 2016.</p>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '30px' }}>
            <div style={{ padding: '30px', background: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', textAlign: 'center' }}>
              ...
              <p>Serving since 2016 with thousands of successful projects.</p>
            </div>
            <div style={{ padding: '30px', background: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', textAlign: 'center' }}>
