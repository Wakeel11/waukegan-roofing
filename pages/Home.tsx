...
const Home = () => {
  ...
  return (
    <div style={{ fontFamily: 'Segoe UI, Roboto, Helvetica, Arial, sans-serif', color: '#1a202c', lineHeight: '1.6' }}>
      ...
      {/* 1. HERO SECTION - NEW CTA CALL BUTTON ADDED */}
      <section style={{ 
        position: 'relative',
        minHeight: '700px',
        display: 'flex',
        ...
        <div style={{ maxWidth: '1100px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '30px' }}>
            <ul style={{ textAlign: 'left', listStyle: 'none', padding: 0, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '15px', maxWidth: '1000px' }}>
              ...
              <li style={{ fontSize: '16px', display: 'flex', alignItems: 'flex-start' }}>
                <span style={{ color: '#f97316', marginRight: '10px', fontWeight: 'bold' }}>✓</span> 
                Code-compliant workmanship and reliable solutions for Lake County homeowners.
              </li>
            </ul>
          </div>
          ...
          <div style={{ marginTop: '50px', display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
            ...
            <a href="tel:8777193793" style={{ 
              ...
              <span style={{ marginRight: '10px' }}>📞</span> CALL 877-719-3793
            </a>
      ...
      <section id="quote-form-section" style={{ padding: '100px 20px', backgroundColor: '#ffffff' }}>
        <div style={{ maxWidth: '1350px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '120px', alignItems: 'center' }}>
          ...
          {/* Right Side Form - Spacing as requested */}
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
            <div style={{ padding: '30px', background: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', textAlign: 'center' }}>
              ...
              <p>Nearly a decade of expert craftsmanship across Illinois and Wisconsin.</p>
            </div>
            <div style={{ padding: '30px', background: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', textAlign: 'center' }}>
              <h3 style={{ color: '#f97316' }}>Local Presence</h3>
              <p>Headquartered at 39089 N Green Bay Rd, Beach Park, IL 60087.</p>
            </div>
            <div style={{ padding: '30px', background: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', textAlign: 'center' }}>
              <h3 style={{ color: '#f97316' }}>Licensed Pro</h3>
              <p>Fully insured and bonded contractors for your complete peace of mind.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#1e3a8a', padding: '80px 20px', color: 'white' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', fontSize: '32px', marginBottom: '40px', fontWeight: '800' }}>Explore Our Service Areas</h2>
